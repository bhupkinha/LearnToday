                    ...
                    <div class="body">
                        ...
                        <div class="form-group form-float">
                                        ...
                                        <div class="select-m" id="get_sub_category">
                                           <?= $this->Form->control('sub_category_id', ['name' => 'sub_category_id','class' => 'form-control select2','style' => 'width:100%;', 'type' => 'select', 'options' => $subCategories, 'label' => 'Location', 'empty' => 'Choose subCategories']) ?> 
                                        </div>
                        </div>
